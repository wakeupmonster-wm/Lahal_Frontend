    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() {
          ...
          if (controller.termsData.value.content.isEmpty) {
            return const WarningDisplay(
              warningMessage: "No Content Found",
              subWarningMessage:
                  "The terms of service are currently unavailable.",
            );
          }
          ...
          return SingleChildScrollView(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  if (controller.termsData.value.title.isNotEmpty) ...[
                    Align(
                  ...
                  Html(
                        data: controller.termsData.value.content
                            .replaceAll("&nbsp;", " ")
                            .replaceAll("\\n", "")
                            .trim(),
                        style: {
