...
///    [AppCalendarDatePicker] and provides an optional compact view where the
...
class AppCalendarDatePicker extends StatefulWidget {
  ...
  /// change the [key] to create a new instance of the [AppCalendarDatePicker], and
...
class _AppCalendarDatePickerState extends State<AppCalendarDatePicker> {
  ...
  void didChangeDependencies() {
    ...
    if (!_announcedInitialDate && widget.initialDate != null) {
      ...
      final String semanticLabelSuffix = isToday
          ? ', ${_localizations.currentDateLabel}'
          : '';
...
/// [AppCalendarDatePicker], or [showDatePicker] which create full date pickers.
///
/// See also:
///
///  * [AppCalendarDatePicker], which provides a Material Design date picker
///    interface.
///
...
class _YearPickerState extends State<YearPicker> {
  ...
  void initState() {
    ...
    _scrollController = ScrollController(
      initialScrollOffset: _scrollOffsetForYear(
