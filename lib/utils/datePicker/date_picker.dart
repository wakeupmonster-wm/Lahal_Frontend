...
// import 'package:mafs/utils/datePicker/calender_date_picker.dart';
...
import 'package:lahal_application/utils/datePicker/calender_date_picker.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:flutter/services.dart';
import 'package:google_fonts/google_fonts.dart';
...
Future<DateTime?> showAppDatePicker({
  ...
  Widget dialog = DatePickerDialog(
    initialDate: initialDate ?? currentDate ?? DateTime.now(),
    firstDate: firstDate,
    lastDate: lastDate,
...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    AppCalendarDatePicker calendarDatePicker() {
      return AppCalendarDatePicker(
...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //         ?.copyWith(color: Color(0xFFFFFFFF), fontFamily: "Roboto");
  ...
  _CalendarDateRangePicker({
    ...
    required this.onEndDateChanged,
       ...
       initialEndDate = initialEndDate != null
           ? DateUtils.dateOnly(initialEndDate)
           : null,
       firstDate = DateUtils.dateOnly(firstDate),
       lastDate = DateUtils.dateOnly(lastDate),
       currentDate = DateUtils.dateOnly(currentDate ?? DateTime.now()) {
...
class _InputDateRangePickerState extends State<_InputDateRangePicker> {
  ...
  Widget build(BuildContext context) {
    ...
    // Explicitly create InputDecorationTheme with proper type
